...
python attack_test.py --net 'WRN' --depth 34 --model_path './FAT_models/fat_for_mart_wrn34-10_eps0.031.pth.tar' --method 'trades'
python attack_test.py --net 'WRN' --depth 34 --model_path './FAT_models/fat_for_mart_wrn34-10_eps0.062.pth.tar' --method 'trades'
