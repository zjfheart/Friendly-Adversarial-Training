...
CUDA_VISIBLE_DEVICES='0' python attack_test.py --net 'WRN' --depth 58 --model_path './FAT_for_TRADES_models/fat_for_trades_wrn58-10_eps0.031_beta6.0.pth.tar' --method 'trades'
CUDA_VISIBLE_DEVICES='0' python attack_test.py --net 'WRN' --depth 58 --model_path './FAT_for_TRADES_models/fat_for_trades_wrn58-10_eps0.062_beta6.0.pth.tar' --method 'trades'
